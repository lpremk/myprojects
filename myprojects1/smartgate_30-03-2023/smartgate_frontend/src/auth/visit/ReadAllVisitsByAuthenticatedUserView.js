...
export default function ReadAllVisitsByRegistrationId(props){
    ...
    const approveVisitByUohShHandler=(id)=>{
        axios({
            method: 'post',
            url: '/visit/update-visit-approved-by-uoh-sh-to-true',
            data: {"id":id}
        })
        .then(res=>{
        ...
        <div className="container d-flex justify-content-center">
            ...
            <h3 className='text-center heading'>Visits</h3> 
                ...
                <thead>
                    ...
                    <th scope="col">Approve Visit By Ga</th>
                    <th scope="col">Exit Visit By Ga</th>
                        ...
                        visits.map(
                            visit=>
                                <tr className="">
                                    ...
                                    onClick={()=>{approveVisitByUohShHandler(visit.id);props.refreshShow();}}
                                    disabled={visit.visitApprovedByUohSh}>Approve</button></td>
                                    ...
                                    <td>{visit.visitApprovedByGa ? 'Approved' : 'Not Approved'}</td>
                                    
                                    <td>{visit.exitApprovedByGa ? 'Exited' : 'Not Exited'}</td>
